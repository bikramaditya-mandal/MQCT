...
## NOTE:
For description of other options, available for the expert calculations, please refer to the PDF file **MQCT USER GUIDE.pdf** available in the root directory. For citing the code, please refer to the article associated with the code as **MQCT.pdf** in the root directory or see it at [the journal webpage](https://doi.org/10.1016/j.cpc.2020.107155).
