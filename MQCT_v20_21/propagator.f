...
!	  do i = 1, states_size
!	  if(i.eq.1) then
	  write(100002,'(f12.5,1x,e23.16,1x,e23.16,1x,e23.16,1x,
!     & e23.16)', advance = 'no')!,1x,,1x,e23.16
     & e23.16,1x,e23.16,1x,e23.16)')tcur,sys_var(1+states_size*2)*
     & dcos(sys_var(5+states_size*2)),sys_var(1+states_size*2)*
     & dsin(sys_var(5+states_size*2)),sys_var(1+states_size*2),
     & sys_var(5+states_size*2),sys_var(2+states_size*2),
     & sys_var(6+states_size*2)
...
!	  do i = 1, states_size
!	  if(i.eq.1) then
!	  write(100002,'(f12.5,1x,e23.16,1x,e23.16,1x,e23.16,1x,e23.16,1x,
!     & e23.16)', advance = 'no')!,1x,,1x,e23.16
!     & tcur, abs(bknorm - 1.0d0), bk_probab, dt, 
!     & sys_var(i), sys_var(i+states_size)
!	  else
!	  write(100002,'(1x,e23.16,1x,e23.16)', advance = 'no') 
!     & sys_var(i), sys_var(i+states_size)
