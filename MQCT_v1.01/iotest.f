...
! This subroutine is written by Alexander Semenov and modified by Bikramaditya Mandal
      ...
      INTEGER, PARAMETER :: num_key_word = 74	  
     ...
     & key,place,decrement,i
      ...
      CHARACTER(LEN=11) :: exch_par_word = "SPIN_WGHT+="         !CASE(55)
...
! This subroutine is written by Alexander Semenov and modified by Bikramaditya Mandal
      ...
      INTEGER, PARAMETER :: num_key_word = 38	  
      INTEGER length,posit,key_word_used(num_key_word),
     & key,place,decrement,i
      CHARACTER(LEN=length) inp
...
! This subroutine is written by Alexander Semenov and modified by Bikramaditya Mandal
      ...
      INTEGER, PARAMETER :: num_key_word = 36	  
      INTEGER length,posit,key_word_used(num_key_word),
     & key,place,decrement,i
      CHARACTER(LEN=length) inp
...
! This subroutine is written by Alexander Semenov and modified by Bikramaditya Mandal
     ...
     & 	v2_ch_temp(:),ja1(:),ja2(:)  
      ...
      EXTERNAL FUNCTION KRONEKER,EXST_STATE	  
